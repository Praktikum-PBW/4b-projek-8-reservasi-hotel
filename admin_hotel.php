                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            ...
                            <input type="submit" value="Tambah" name="proses" class="btn btn-primary">
                        </form>
                         <?php

                    
                                    if(isset($_POST['proses'])){
                                        mysqli_query($conn, "insert into hotel set
                                        hotel = '$_POST[nama]',
            ...
            <div class="col-md-10 mx-auto">
                 <div class="card">
                     ...
                     <div class="card-body">
                         ...
                         <td><?= $row ["rating"]; ?></td>
                         <td scope="row">
                                    <a href="ubah_hotel.php?op=edit&id=<?= $row["id"]; ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                    <a href="hapus_hotel.php?op=hapus&id=<?= $row["id"]; ?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger">Delete</button></a>            
                                </td>
                        </tr>
                        <?php $i++; ?>
                        <?php endforeach; ?>
